...
Erstelle zwei Dateien mit demselben Namen in verschiedenen Verzeichnissen (z.B. `dir1/file` und `dir2/file`), öffne nacheinander beide mit dem Editor `nano` und trage unterschiedlichen Inhalt ein (z.B. `ich bin file in dir1` und `ich bin file in dir2`). Kopiere nun `dir1/file` nach `dir2/file`. Untersuche, was passiert.
